...
[转载大佬]([nexus3 磁盘空间满后 docker 启动报"cannot open local storage '/nexus-data/db/config' with mode=rw" - 特拉仔的个人空间 - OSCHINA - 中文开源技术交流社区](https://my.oschina.net/u/3049601/blog/4724864))
